...
class ParallelogramAreaInMeters extends StatelessWidget {
  const ParallelogramAreaInMeters({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(scaffoldChild: SizedBox(
      ...
      child:    const SingleChildScrollView(
        ...
        child: Column(
          children: [
            SectionOneParallelogramArea(feetScreen: false),
            SectionTwoParallelogramArea(feetScreen: false),
            ResultSectionParallelogramArea(feetScreen: false),
          ],
        ),
      ),
