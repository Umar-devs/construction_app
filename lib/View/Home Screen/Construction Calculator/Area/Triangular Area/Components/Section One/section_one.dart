...
import '../../triangular_area_in_feet.dart';
import '../../triangular_area_in_meters.dart';

class SectionOneTriangularArea extends StatelessWidget {
  const SectionOneTriangularArea({super.key, required this.feetScreen});
    ...
    return Column(
      children: [
        ...
        const TitleBoxWithImageBlocks(
            imgPath: 'assets/images/triangle area.png',
            title: 'Calculate triangle\nArea'),
        SizedBox(
        ...
        CustomBtn(
          ...
          onPress: () {
            feetScreen
                ...
                : Get.to(const TriangularAreaInFeet(),
                    transition: Transition.size,
                    duration: const Duration(milliseconds: 1200));
          },
          btnFontSize: 0.035,
