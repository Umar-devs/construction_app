...
class CircularAreaInMeters extends StatelessWidget {
  const CircularAreaInMeters({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(scaffoldChild: SizedBox(
      ...
      child:   const SingleChildScrollView(
        ...
        child: Column(
          children: [
            SectionOneCircularArea(feetScreen: false),
            SectionTwoCircularArea(feetScreen: false),
            ResultSectionCircularArea(feetScreen: false),
          ],
        ),
      ),
