...
class TriangularAreaInFeet extends StatelessWidget {
  const TriangularAreaInFeet({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(scaffoldChild: SizedBox(
      ...
      child:  const SingleChildScrollView(
        ...
        child: Column(
          children: [
            SectionOneTriangularArea(feetScreen: true),
            SectionTwoTriangularArea(feetScreen: true),
            ResultSectionTriangularArea(feetScreen: true),
          ],
        ),
      ),
