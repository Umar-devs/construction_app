...
class ParallelogramAreaInFeet extends StatelessWidget {
  const ParallelogramAreaInFeet({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(scaffoldChild: SizedBox(
      ...
      child:    const SingleChildScrollView(
        ...
        child: Column(
          children: [
            SectionOneParallelogramArea(feetScreen: true),
            SectionTwoParallelogramArea(feetScreen: true),
            ResultSectionParallelogramArea(feetScreen: true),
          ],
        ),
      ),
