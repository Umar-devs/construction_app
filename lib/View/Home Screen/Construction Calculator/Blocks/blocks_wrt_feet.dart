...
class BlocksDimensionsInFeet extends StatefulWidget {
  const BlocksDimensionsInFeet({super.key});

  @override
  State<BlocksDimensionsInFeet> createState() => _BlocksDimensionsInFeetState();
}

class _BlocksDimensionsInFeetState extends State<BlocksDimensionsInFeet> {
  @override
  void initState() {
    super.initState();
    blockController.getThicknessWallDimension(double.tryParse('8'));
    blockController.getQuantityWallDimension(double.tryParse('1'));
    blockController.getLengthBlockDimension(double.tryParse('16'));
    blockController.getHeightBlockWallDimension(double.tryParse('8'));
    blockController.getWidthBlockWallDimension(double.tryParse('8'));
                ...
                CustomBtn(
                  ...
                  onPress: () {
                    if (blockController.lengthInWallDimension.value == 0.0 ||
                      ...
                      blockController.calculateNumberOfBlocks();
                    }
                  },
                  btnFontSize: 0.035,
