...
class InputFieldRowConcrete extends StatelessWidget {
  InputFieldRowConcrete({
    ...
    this.wantTitle = true,  this.contentPaddingRight=0,
  });
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        contentPadding:  EdgeInsets.only(
                          bottom: 13,right: contentPaddingRight,
                        ),
                        hintStyle: TextStyle(
