...
class RoomDimensionsInFeet extends StatelessWidget {
  const RoomDimensionsInFeet({super.key});
    ...
    return  CustomScaffold(
        scaffoldChild: SizedBox(
          ...
          child:  const SingleChildScrollView(
            ...
            child: Column(
              children: [
                SectionOneRoom(feetScreen: true),
                SectionTwoRoom(feetScreen: true),
                ResultSectionRoom(feetScreen: true)
              ],
            ),
          ),
        ), title: 'Total Room Brick Unit');
  }
}
